    ...
    public class TableChanges : IDisposable
    {
            ...
            bool leftToRight, RowsCopyingProgressHandler handler)
        {
            ...
            for (int i = 0; i < common.Count; i++)
            {
                ...
                var dsttype = Utils.GetDbType(common[i].ColumnType);
            ...
            long rowid, object updatedValue, SQLiteConnection dbconn, SQLiteTransaction tx)
        {
            ...
            SQLiteCommand res = new SQLiteCommand(
                ...
                dbconn, tx);
            var dbtype = Utils.GetDbTypeFromClrType(column, updatedValue);
        ...
        private SQLiteCommand CreateAddCommand(string tableName)
        {
            ...
            res.Parameters.Add("@cres", DbType.Int64);
            res.Parameters.Add("@left", DbType.Int64);
            res.Parameters.Add("@right", DbType.Int64);
            res.Parameters.Add("@blobs", DbType.String);
